...
//     G4int n_hit = mppcHC->entries();
   ...
   G4cout << "<<< fPhotCountX= " << fPhotCountX << G4endl; // add
   G4cout << "<<< fPhotCountY= " << fPhotCountY << G4endl; // add
   G4cout << "<<< fPhotCountZ= " << fPhotCountZ << G4endl; // add

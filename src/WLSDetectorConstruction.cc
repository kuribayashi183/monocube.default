...
void WLSDetectorConstruction::ConstructFiber()
{
  ...
  new G4PVPlacement(0,
	...
	//	G4double fHolePos = 2*mm;
  	new G4PVPlacement(rotMX, G4ThreeVector(+fHolePos,fWLSfiberZ-fWLSfiberl,+fHolePos), logicPhotonDetX, "PhotonDetX", fLogiWorld, false, 0);
  	new G4PVPlacement(rotMY, G4ThreeVector(fWLSfiberZ-fWLSfiberl,+fHolePos,-fHolePos), logicPhotonDetY, "PhotonDetY", fLogiWorld, false, 0);
  	new G4PVPlacement(0,     G4ThreeVector(-fHolePos,-fHolePos,fWLSfiberZ-fWLSfiberl), logicPhotonDetZ, "PhotonDetZ", fLogiWorld, false, 0);
